...
export default function Navruz() {
  return (
    <motion.div
    ...
    >
      ...
      >
        <source src="/videos/navruz.mp4" type="video/mp4" />
      </motion.video>
      ...
      >
        Celebrate the Persian New Year — a symbol of renewal, colors, and unity across Tajikistan.
      </motion.p>
    </motion.div>
  );
}
